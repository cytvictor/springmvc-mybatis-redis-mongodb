...
<body>
	...
	<div class="container">
		...
		<div class="content">
			...
			<input type="hidden" name = "funType" id="funType" value="${resource.funType }"/>
			<div class="otContent">
				<div class="selectBoxTop">
					...
					<p>资源类型：
						<c:if test="${resource.funType == 'FUN_TYPE_VIDEO' }">视频</c:if>
						<c:if test="${resource.funType == 'FUN_TYPE_PICTURE' }">图片</c:if>
						<c:if test="${resource.funType == 'FUN_TYPE_TEXT' }">文字</c:if>
					</p>
				</div>
				<div class="selectBox mt20">
					...
					<div id="tagThumb" <c:if test="${resource.funType == 'FUN_TYPE_TEXT' }">style="display: none;"</c:if>>
					...
					<div id="tagPicture" <c:if test="${resource.funType != 'FUN_TYPE_PICTURE' }">style="display: none;"</c:if>>
					</div>
					<div id="tagText" <c:if test="${resource.funType != 'FUN_TYPE_TEXT' }">style="display: none;"</c:if>>
						<h5><b class="red">∗</b>内容：</h5>
						<ul>
							<li>
			                    <textarea id="funContent" name="funContent" style="width:600px;height:300px;" maxlength="1200" >${resource.funContent }</textarea><span class="gray">可输入1200个汉字</span>
							</li>
						</ul>
					</div>
					<h5>标签：</h5>
