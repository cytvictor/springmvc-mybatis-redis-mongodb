...
<body>
		...
		<div class="otContent">
			<div class="tabBox shareExam currBox">
				<ul>
					...
					<li>
						<label>分类：</label>
						<select id='teachCatalogRoot' class="easyui-combobox" name='teachCatalogRoot' style='width:80px;' data-options='editable:false, valueField:"id", textField:"catalogName", onChange:onTeachCatalogChange'>
							<option value="">请选择</option>
						</select>
						<div id="teachCatalogContainer" style="display:inline;"></div>
					</li>
				</ul>
			</div>
			<div class="submitBtn">
	...
	<script type="text/javascript">
		...
		function saveCatalog(){
			var id = formatResourceCatalogId("teachCatalogRoot", -1);
			if (id == -1){
				Win.alert("请选择资源的分类!");
				return;
			} else {
