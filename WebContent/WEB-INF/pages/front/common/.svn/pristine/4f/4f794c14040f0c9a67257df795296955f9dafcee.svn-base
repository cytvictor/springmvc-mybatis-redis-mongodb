...
<div class="side"  style="height:1200px;">
	...
	<ul class="sideNav">
		...
		<li class="liveAppointment"><a href="${session_domain_config.userCenter }/user/loginWithUrl.html?username=${sessionScope.session_login_user.username }&password=666666&url=${session_domain_config.onlineClass }/monitor/schoolNet/appointment/list.html">直录播课堂</a></li>
		<li class="evaluation"><a href="${session_domain_config.userCenter }/user/loginWithUrl.html?username=${sessionScope.session_login_user.username }&password=666666&url=${session_domain_config.evaluation }/eva/index.html">资源评选</a></li>
		<li class="prepareLession"><a href="${session_domain_config.userCenter }/user/loginWithUrl.html?username=${sessionScope.session_login_user.username }&password=666666&url=${session_domain_config.meeting }/prepareLesson/createList.html">集体备课</a></li>
	</ul>
</div>
