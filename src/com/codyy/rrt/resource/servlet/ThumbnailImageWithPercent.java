...
public class ThumbnailImageWithPercent extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ThumbnailImageTransfer thumbnailImageTransfer;

	public ThumbnailImageWithPercent() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (file.exists()) {
				...
				ImageIO.write(thumbnailImageTransfer.getThumbnailImageWithPercent(file, width, height),"JPEG", response.getOutputStream());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
